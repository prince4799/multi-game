...
const GAMES = [
  ...
  // ── ARCADE ────────────────────────────────────────────────────────
  {
    ...
    category: 'arcade',
    icon: 'fas fa-cube',
    description: 'High-performance 3D Snake with neon aesthetics and smooth WebGL rendering.',
    ...
    difficulty: 'medium',
    ageRating: 'all',
    tags: ['snake', '3d', 'ogl', 'neon', 'arcade'],
    featured: true
  },
  {
    id: 'breakout-3d',
    title: 'Breakout 3D OGL',
    category: 'arcade',
    icon: 'fas fa-th',
    description: 'A stunning 3D brick breaker with neon physics and reactive lighting.',
    htmlFile: 'games/basics/breakout-ogl/index.html',
    controls: {
      controlType: 'none',
      keyboard: true,
      mouse: true,
    ...
    difficulty: 'medium',
    ageRating: 'all',
    tags: ['breakout', '3d', 'ogl', 'neon', 'arcade'],
    featured: true
  },
  ...
  },
  {
    ...
    category: 'brain-train',
    icon: 'fas fa-font',
    description: 'Sprint through the cosmos! Run, jump, and crouch to collect letters and spell words in this high-speed 3D brain train.',
    htmlFile: 'games/brain-train/spell-run/index.html',
    controls: {
      controlType: 'none',
      keyboard: false,
      hideHints: true,
    ...
    difficulty: 'medium',
    ageRating: 'all',
    tags: ['spelling', '3d', 'runner', 'forest', 'nature', 'brain'],
    featured: true
  },
  {
